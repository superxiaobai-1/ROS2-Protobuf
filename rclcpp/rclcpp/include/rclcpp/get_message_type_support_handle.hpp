...
typename std::enable_if_t<
  ...
  !rclcpp::detail::is_protobuf_message<AdaptedType>::value,
  const rosidl_message_type_support_t &
>
get_message_type_support_handle()
{
...
typename std::enable_if_t<
  !rosidl_generator_traits::is_message<ProtobufMessageT>::value &&
  rclcpp::detail::is_protobuf_message<ProtobufMessageT>::value,
  const rosidl_message_type_support_t &
>
get_message_type_support_handle()
{
  return rclcpp::detail::get_protobuf_message_type_support_handle_fastrtps_cpp<ProtobufMessageT>();
}
