...
public:
  ...
  : rclcpp::Node("latency_ros2msg_big_listener", options)
  {
    ...
    sub_ = this->create_subscription<sensor_msgs::msg::Image>(
      ...
      [this](const sensor_msgs::msg::Image & msg) { this->on_msg(msg); });
  }

private:
  void on_msg(const sensor_msgs::msg::Image & msg)
  {
...
int main(int argc, char ** argv)
{
  ...
  rclcpp::spin(std::make_shared<demo_nodes_cpp::LatencyRos2MsgBigListener>(rclcpp::NodeOptions{}));
  rclcpp::shutdown();
  return 0;
}
