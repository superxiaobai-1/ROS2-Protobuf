...
public:
  ...
  : rclcpp::Node("latency_protobuf_nested_talker", options)
  {
    ...
    pub_ = this->create_publisher<example::proto::Nested>(topic_, rclcpp::QoS(10));
...
private:
  ...
  size_t sent_{0};
  example::proto::Nested msg_;
  rclcpp::Publisher<example::proto::Nested>::SharedPtr pub_;
...
int main(int argc, char ** argv)
{
  ...
  rclcpp::spin(std::make_shared<example::LatencyProtobufNestedTalker>(rclcpp::NodeOptions{}));
  rclcpp::shutdown();
  return 0;
}
